...
BENCHMARK(fp16_ieee_to_fp32_bits)->RangeMultiplier(2)->Range(1<<10, 1<<20);
...
BENCHMARK(fp16_ieee_to_fp32_value)->RangeMultiplier(2)->Range(1<<10, 1<<20);
...
BENCHMARK(fp16_ieee_to_fp32_psimd)->RangeMultiplier(2)->Range(1<<10, 1<<20);
	...
	BENCHMARK(fp16_ieee_to_fp32_hardware)->RangeMultiplier(2)->Range(1<<10, 1<<20);
#endif
